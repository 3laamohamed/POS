...
Route::group(['prefix' => 'Reports' , 'namespace' => 'ReportsController'] ,function(){
  ...
  Route::get('Customer_Report_view','CustomerController@Customer_Report_view') ->name('Customer_Report_view');
  Route::post('customer_report','CustomerController@customer_report') ->name('customerreportsearch');
