            ...
            <div class="dash-box">
              ...
              <div class='box'>
                ...
                <i class="fas fa-hand-holding-usd fa-3x" style='color:#8e44ad'></i>
                  <h2 style='color:#8e44ad'><span id="salesshow">{{ $data['sales']}}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                <i class="fas fa-hand-holding-usd fa-3x" style='color:#8e44ad'></i>
                  <h2 style='color:#8e44ad'><span id="sales_agel">{{ $data['agel'] }}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                <i class="fas fa-hand-holding-usd fa-3x" style='color:#8e44ad'></i>
                  <h2 style='color:#8e44ad'><span id="sales_back">{{ $data['back'] }}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                <i class="fas fa-hand-holding-usd fa-3x" style='color:#8e44ad'></i>
                  <h2 style='color:#8e44ad'><span id="sales_backacc">{{ $data['backofcus']}}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                  ...
                  <h2 style='color: #2ab4c0'><span id="Spending">{{ $data['Spending']}}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                  <i class="fas fa-fist-raised fa-3x" style='color: #2ab4c0'></i>
                  <h2 style='color: #2ab4c0'><span id="supply">{{ $data['supply']}}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                  <i class="fas fa-fist-raised fa-3x" style='color: #2ab4c0'></i>
                  <h2 style='color: #2ab4c0'><span id="exchange">{{$data['exchange']}}</span></h2>
                </div>
              ...
              <div class='box'>
                <div class="content">
                  ...
                  <h2 style='color: #4b77be'><span id="total">{{ $data['total'] }}</span></h2>
                </div>
